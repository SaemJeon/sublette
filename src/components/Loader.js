...
const Loader = () => {
    ...
    useEffect(() => {
        const que = query(collection(dbService, "listings"), orderBy("createdAt", "desc"));
    ...
    return (
        // <RenderData imgList={imgListData} dataList={listData}/>
        <></>
    )
}
...
function RenderData({imgList, dataList}) {
